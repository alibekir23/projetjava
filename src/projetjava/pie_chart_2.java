...
public class pie_chart_2 extends Application { 
   ...
   public void buildData(){
        try {
            ...
            PreparedStatement pt = conn.prepareStatement("select nbr_mois_payer ,COUNT(nbr_mois_payer) as nbr from user group by nbr_mois_payer ");
            ResultSet rs = pt.executeQuery();
            while(rs.next()){
                //adding data on piechart data
                data_pie.add(new PieChart.Data(rs.getString("nbr_mois_payer"),rs.getInt(2)));
            }
