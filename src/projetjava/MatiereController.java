			...
			filteredData.setPredicate(matiere -> {
				...
				String lowerCaseFilter = newValue.toLowerCase();
				     ...
				     return true;
                                ...
                                else if (String.valueOf(matiere.getDescription()).indexOf(lowerCaseFilter)!=-1)
				     return true;
...
alert.setContentText("Are you sure you want to delete this module?");
...
if (result.get() == ButtonType.OK){
    ...
    @FXML
   public void NewMatiere(ActionEvent event){
       
       try{
                  Node source = (Node) event.getSource();
     Stage stage = (Stage) source.getScene().getWindow();
         stage.hide(); 
           FXMLLoader fxmlLoader= new FXMLLoader(getClass().getResource("Ajouter_Module.fxml"));
   ...
   public void Modifier(ActionEvent event){
        ...
        if(tab.getSelectionModel().getSelectedItem()==null)
        {
           Alert alert = new Alert(Alert.AlertType.ERROR);
                alert.setTitle("ERROR");
                alert.setHeaderText(null);
                alert.setContentText("Please select a module to edit!");
                alert.show();            
        c1=false;
        }
     ...
     Stage stage = (Stage) source.getScene().getWindow();
         stage.hide(); 
           FXMLLoader fxmlLoader= new FXMLLoader(getClass().getResource("Modifier_Module.fxml"));
           Parent root1=(Parent) fxmlLoader.load();
     //  Stage stage= new Stage();
       Modifier_ModuleController controller=fxmlLoader.getController();
